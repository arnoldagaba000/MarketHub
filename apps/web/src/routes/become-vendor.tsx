...
function BecomeVendorPage() {
	...
	const createVendorMutation = useMutation({
		...
		onError: (error) => {
			toast.error((error as Error).message || "Failed to create vendor profile");
		},
	});
			...
			<div className="container mx-auto px-4 py-8">
				<Card>
					<CardContent className="p-6 text-center">
						...
						<h2 className="mb-2 font-bold text-2xl">You're already a vendor!</h2>
						<p className="mb-4 text-muted-foreground">
							You already have a vendor profile. Visit your dashboard to manage
							your shop.
						</p>
	...
	return (
		<div className="container mx-auto max-w-2xl px-4 py-8">
			...
			<Card>
				<CardHeader>
					<h2 className="font-semibold text-xl">Vendor Information</h2>
					<p className="text-muted-foreground text-sm">
						Fill in your shop details to get started. Your profile will be
							...
							{(field) => (
								<div className="space-y-2">
									...
									<p className="text-muted-foreground text-xs">
										Optional: Describe what makes your shop special
									</p>
									{field.state.meta.errors.map((error) => (
										<p className="text-destructive text-sm" key={error}>
											{error}
